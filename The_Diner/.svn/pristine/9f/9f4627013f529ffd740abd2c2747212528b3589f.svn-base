...
<div id="middle">	
	...
	<div class="menuMenu">
		...
		<div class="contents">
			<div class="pclist1">
		<form action = "Question_D_Writepro.jsp" method = "post" >
			<table	style="width: 100%">
				...
				<tr style="height: 40px; border-bottom: 1px solid #ddd;">
						...
						<td style="padding-left: 50px; padding-right: 50px; border-left: 1px solid #ddd; align-content: center;" ><input id="gul_1" type= "text" name = "title" size = "60" style="width: 100%"><div id="gul_so_1"></div></td>
				</tr>
				...
				<button onclick="location.href='Question_D_Listform.jsp'">전체 게시글 보기</button> <!-- 여기에 들어온곳 으로 이동하게 경로짜줘야함  -->
			</div>
		</div>
	</div>
</div>
