...
<div id="middle">	
	...
	%>	
				...
				<colgroup> 
				 ...
				 <col width="340px" style="border-right: 2px solid #ddd; " />
				 <col width="145px" style="border-right: 2px solid #ddd; " />
			...
			%>
					<tr style="height: 30px; border-bottom: 1px solid #ddd;">
						...
						<td style =" text-decoration:none; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; padding-left: 10px; padding-right: 10px;" align="center">
							<a href= "Review_D_Info.jsp?num=<%=number%>">
							<%=vo.getTitle()%>
							</a>
						</td>
						<td align="center"><%=vo.getId()%></td>
						<td align="center"><%=vo.getStar()%></td>
