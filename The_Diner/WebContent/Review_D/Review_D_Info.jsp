...
<div id="middle">	
	...
	<% 
		...
		Review_VO vo = rdao.getOneBoard(num);
	%>
			...
			<table width = "100%">
				...
				<tr style="height: 40px; border-bottom: 1px solid #ddd;">
					<td width = "120" align ="center">별점 갯수</td>
					<td colspan = "3" align ="center" style="border-left: 1px solid #ddd;"><%=vo.getStar()%></td>
				</tr>	
				<tr style="height: 40px; border-bottom: 1px solid #ddd;">
				...
				<tr style="min-height: 400px; border-bottom: 1px solid #ddd;">
					...
					<td colspan = "3" align ="center" style=" padding-left: 50px; padding-right: 50px; border-left: 1px solid #ddd;"><textarea rows= "10" cols = "60" name = "content" style=" width: 100%; height: 320px; vertical-align: middle; " readonly="readonly"><%=vo.getContent2()%></textarea></td>
				</tr>
				
				<tr height = "40">
					<td align ="center" colspan = "4"> 
						<% if(vo.getId().equals(session.getAttribute("mname"))) {%>
						<input type="button" value="수정하기" onclick="location.href='Review_D_Updateform.jsp?num=<%=vo.getNum()%>'"> 
						...
						<% } %>
						<% if(vo.getId().equals(session.getAttribute("mname"))) {%>
						<input type="button" value="삭제하기" onclick="location.href='Review_D_Deleteform.jsp?num=<%=vo.getNum()%>'"> 
						<% } else if(session.getAttribute("mname") == null || session.getAttribute("mname").equals("manager")){ 
						...
						<input type="button" value="목록보기" onclick="location.href='Review_D_Listform.jsp'">
					</td>
				</tr>
		</table>
